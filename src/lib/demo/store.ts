  ...
  return {
    ...
    thought_patterns: [
      ...
      },
      {
        id: "demo-pattern-2",
        user_id: DEMO_USER_ID,
        name: "Procrastinação por perfeccionismo",
        ...
        new_evidence: "Três projetos iniciados neste mês",
    ...
    journal_entries: [
      ...
      },
      {
        ...
        content: "Respondi na reunião em vez de esperar o fim. Sobrevivi — e fui ouvida.",
