  ...
  return {
    ...
    thought_patterns: [
      ...
      },
      {
        id: "demo-pattern-4",
        user_id: DEMO_USER_ID,
        name: "Perfeccionismo · revisar sem parar",
        trigger_text: "Terminar um texto ou uma entrega",
        thought: "Se eu reler mais uma vez, vai melhorar",
        emotion: "Insegurança",
        old_response: "Revisar até o prazo estourar",
        old_result: "Entrego cansada e continuo duvidando",
        new_thought: "Revisão extra depois da terceira leitura é medo, não qualidade",
        new_action: null,
        new_evidence: null,
        created_at: hoursAgoISO(24 * 12),
      },
      {
        id: "demo-pattern-5",
        user_id: DEMO_USER_ID,
        name: "Comparação · o ritmo dos outros",
        trigger_text: "Ver alguém publicar mais uma conquista",
        thought: "Estou atrasada na vida",
        emotion: "Desânimo",
        old_response: "Rolar o feed e me comparar por mais uma hora",
        old_result: "Perco o dia e não produzo nada do que é meu",
        new_thought: "O ritmo deles não é a minha medida; o meu passo é",
        new_action: "Fechar o feed e escrever 20 minutos no que é meu",
        new_evidence: "Fechei o feed na quinta e terminei o capítulo que estava parado há semanas",
        created_at: hoursAgoISO(24 * 44),
      },
    ],
    journal_entries: [
      {
      ...
      },
      {
        id: newId(),
        user_id: DEMO_USER_ID,
        prompt: "Evidência da rota: Comparação · o ritmo dos outros",
        content: "Fechei o feed e escrevi por 20 minutos. O capítulo saiu.",
        created_at: hoursAgoISO(24 * 43),
      },
      {
        id: newId(),
        user_id: DEMO_USER_ID,
